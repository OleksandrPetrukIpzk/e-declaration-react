            ...
            <Container maxWidth="lg" sx={{ py: 4 }}>
                <Box sx={{ mb: 4 }}>
                    ...
                    <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
                        Повний список адміністраторів системи
                    </Typography>

                    <TextField
                        fullWidth
                        placeholder="Пошук за іменем, email, телефоном, професією, регіоном..."
                        value={searchQuery}
                    ...
                    <>
                        ...
                        {(!filteredUsers || filteredUsers.length === 0) && (
                            <Box sx={{ textAlign: 'center', py: 8 }}>
                                ...
                                <Typography variant="h6" color="text.secondary">
                                    {searchQuery ? 'Адміністраторів не знайдено' : 'Немає адміністраторів'}
                                </Typography>
                                {searchQuery && (
                        ...
                        {filteredUsers && filteredUsers.length > 0 && (
                            <Box sx={{ mt: 3, textAlign: 'center' }}>
                                <Typography variant="body2" color="text.secondary">
                                    Знайдено адміністраторів: {filteredUsers.length}
