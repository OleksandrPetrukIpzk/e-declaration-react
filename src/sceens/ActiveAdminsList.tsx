            ...
            <Container maxWidth="lg" sx={{ py: 4 }}>
                <Box sx={{ mb: 4 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                        <AdminPanelSettingsIcon sx={{ fontSize: 36, mr: 2, color: 'success.main' }} />
                        <Typography variant="h4" component="h1" sx={{ fontWeight: 600 }}>
                            Активні адміністратори
                        </Typography>
                    </Box>
                    <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
                        Список активних адміністраторів системи
                    </Typography>
                    ...
                    <>
                        ...
                        {(!filteredUsers || filteredUsers.length === 0) && (
                            <Box sx={{ textAlign: 'center', py: 8 }}>
                                ...
                                <Typography variant="h6" color="text.secondary">
                                    {searchQuery ? 'Адміністраторів не знайдено' : 'Немає активних адміністраторів'}
                                </Typography>
                                {searchQuery && (
                        ...
                        {filteredUsers && filteredUsers.length > 0 && (
                            <Box sx={{ mt: 3, textAlign: 'center' }}>
                                <Typography variant="body2" color="text.secondary">
                                    Знайдено активних адміністраторів: {filteredUsers.length}
